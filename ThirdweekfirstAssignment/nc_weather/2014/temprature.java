...
public class temprature {
        ...
        for(CSVRecord record : parser)
        {
            ...
            if(!temp.contains("N/A"))
            {
                if(humidsofar == null)
                {
                    ...
                    String str1 = record.get("Humidity");
                    String str2 = humidsofar.get("Humidity");
                    if (!str1.contains("N/A") && !str2.contains("N/A") )
                    {
                        double temp1 = Double.parseDouble(str1);
                        double currtemp = Double.parseDouble(str2);
    ...
    public CSVRecord lowestHumidityInManyFiles()
    {
        ...
        for(File f : dr.selectedFiles())
        {
            ...
            if(!temp.contains("N/A"))
            {
                ...
                double temp1 = Double.parseDouble(lowestsofar.get("Humidity"));
    ...
    public void testAverageTemperatureInFile()
    {
        ...
        System.out.println("The avg temperature is : " + avgtemp);
    }
